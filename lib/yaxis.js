...
exports.default = _react2.default.createClass({
    ...
    renderAxis: function renderAxis(align, scale, width, absolute, fmt) {
        ...
        if (this.props.type === "linear" || this.props.type === "power") {
            ...
            axisGenerator = axis().scale(scale).ticks(10, ".2s");
        }
    ...
    updateAxis: function updateAxis(align, scale, width, absolute, type, fmt) {
        ...
        var t = (0, _d3Transition.transition)().duration(this.props.transition).ease(_d3Ease.easeSinOut);

        (0, _d3Selection.select)(_reactDom2.default.findDOMNode(this)).select(".yaxis").transition(t).call(axisGenerator);
    },
